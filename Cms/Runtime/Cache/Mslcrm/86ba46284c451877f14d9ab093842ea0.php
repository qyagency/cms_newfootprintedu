...
<head>
    <meta charset="UTF-8">
    <title>
        客户信息 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">客户姓名:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="客户姓名:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_name" value="<?php echo ($vo["user_name"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">邮箱:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="邮箱:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_email" value="<?php echo ($vo["user_email"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">地区:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="地区:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_location" value="<?php echo ($vo["user_location"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">项目名称:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="项目名称:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_project" value="<?php echo ($vo["user_project"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">所属公司:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="所属公司:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_company" value="<?php echo ($vo["user_company"]); ?>" required>      </div></div>
        </div>
