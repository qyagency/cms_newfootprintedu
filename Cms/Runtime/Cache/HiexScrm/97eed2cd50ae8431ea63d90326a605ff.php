...
<head>
    <meta charset="UTF-8">
    <title>
        设备分布 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">设备<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="设备" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Xaxis" value="<?php echo ($vo["xaxis"]); ?>" required>      </div></div>
