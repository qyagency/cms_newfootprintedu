...
<head>
    <meta charset="UTF-8">
    <title>
        表单位置分布 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">位置<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="位置" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Xaxis" value="<?php echo ($vo["xaxis"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">数目<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="数目" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Yaxis" value="<?php echo ($vo["yaxis"]); ?>" required>      </div></div>
        </div>
