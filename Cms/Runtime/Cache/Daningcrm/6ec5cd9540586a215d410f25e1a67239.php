...
<head>
    <meta charset="UTF-8">
    <title>
        活动场次信息 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">活动名称:<span class="required">*</span></label>   <div class="col-md-8">       <select data-plugin-selectTwo class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Activity_id" required  >               <option value="">请选择</option>           <?php if(is_array($vo["ActivityIdList"])): $i = 0; $__LIST__ = $vo["ActivityIdList"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vos["key"]); ?>" <?php echo ($vos["readonly"]); ?> <?php if(($vos["key"]) == $vo["activity_id"]): ?>selected<?php endif; ?>><?php echo ($vos["label"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>       </select>   </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">场次名:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="场次名:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Session_name" value="<?php echo ($vo["session_name"]); ?>" required>      </div></div>
            <div class="form-group">    <label class="col-md-2 control-label">场次日期:<span class="required">*</span></label>    <div class="col-md-8">        <div class="input-group">            <span class="input-group-addon">                <i class="fa fa-calendar"></i>            </span>            <input name="<?php echo (CONTROLLER_NAME); ?>Session_date" type="text" value="<?php echo ($vo["session_date"]); ?>" required data-plugin-datepicker class="form-control">        </div>    </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">开始时间:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="开始时间:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Session_start_time" value="<?php echo ($vo["session_start_time"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">限定人数:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="限定人数:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Session_limit" value="<?php echo ($vo["session_limit"]); ?>" required>      </div></div>
        </div>
