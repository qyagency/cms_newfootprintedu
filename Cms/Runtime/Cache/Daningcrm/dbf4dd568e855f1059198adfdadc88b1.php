...
<head>
    <meta charset="UTF-8">
    <title>
        办事信息 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">指南类型:<span class="required">*</span></label>   <div class="col-md-8">       <select data-plugin-selectTwo class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Workguild_type" required  >               <option value="">请选择</option>           <?php if(is_array($vo["StatusList"])): $i = 0; $__LIST__ = $vo["StatusList"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vos["key"]); ?>" <?php echo ($vos["readonly"]); ?> <?php if(($vos["key"]) == $vo["workguild_type"]): ?>selected<?php endif; ?>><?php echo ($vos["label"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>       </select>   </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">指南标题:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="指南标题:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Workguild_title" value="<?php echo ($vo["workguild_title"]); ?>" required>      </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">办理依据:</label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>Workguild_basis" class="form-control"  ><?php echo ($vo["workguild_basis"]); ?></textarea>    </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">申办条件:</label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>Workguild_condition" class="form-control"  ><?php echo ($vo["workguild_condition"]); ?></textarea>    </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">申办材料:</label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>Workguild_materials" class="form-control"  ><?php echo ($vo["workguild_materials"]); ?></textarea>    </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">办理程序:</label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>Workguild_procedure" class="form-control"  ><?php echo ($vo["workguild_procedure"]); ?></textarea>    </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">收费标准:</label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>Workguild_charges" class="form-control"  ><?php echo ($vo["workguild_charges"]); ?></textarea>    </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">其它:</label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>Workguild_others" class="form-control"  ><?php echo ($vo["workguild_others"]); ?></textarea>    </div></div>
        </div>
