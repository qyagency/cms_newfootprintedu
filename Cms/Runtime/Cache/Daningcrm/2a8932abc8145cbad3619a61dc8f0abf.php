...
<head>
    <meta charset="UTF-8">
    <title>
        活动信息 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">活动名称:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="活动名称:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Activity_name" value="<?php echo ($vo["activity_name"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">活动时间:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="活动时间:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Activity_can_use_time" value="<?php echo ($vo["activity_can_use_time"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">活动地址:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="活动地址:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Activity_address" value="<?php echo ($vo["activity_address"]); ?>" required>      </div></div>



<!--            <div class="form-group">   <label class="col-md-2 control-label">活动图片:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="活动图片:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Activity_img" value="<?php echo ($vo["activity_img"]); ?>" required>      </div></div>-->
            <input type="hidden" name = "ActivityInfoActivity_img" id = "activity_img" value="<?php echo ($vo["activity_img"]); ?>" />
<!--            <a id="zwb_upload">
                <input type="file" class="add" multiple>点击上传文件
            </a>
            <input type="text" name="filePath" id="callbackPath2">-->

            <label class="col-md-2 control-label" for="textareaDefault">活动图片:</label>
            <a><img  height="120px" width="160px" src="<?php echo ($vo["activity_img1"]); ?>" id="img-change" class="activity_img" alt="活动图片" /></a>
            <a><img  height="120px" width="160px" src="<?php echo ($vo["activity_img2"]); ?>" id="img-change2" class="activity_img" alt="活动图片" /></a>
            <a><img  height="120px" width="160px" src="<?php echo ($vo["activity_img3"]); ?>" id="img-change3" class="activity_img" alt="活动图片" /></a>
            ...
            <div class="form-group">   <label class="col-md-2 control-label">活动排序:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="活动排序:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Activity_sort" value="<?php echo ($vo["activity_sort"]); ?>" required>      </div></div>
            ...
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">活动简介:<span class="required">*</span></label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>Activity_details" class="form-control" required ><?php echo ($vo["activity_details"]); ?></textarea>    </div></div>
...
/*        $("#zwb_upload").bindUpload({
            url:"http://daning-crm.cms.incker.com/api/upactivity",//上传服务器地址
            callbackPath:"#activity_img",//绑定上传成功后 图片地址的保存容器的id或者class 必须为input或者textactivity等可以使用$(..).val()设置之的表单元素
        ...
        var filechange=function(event){
            ...
            if (files && files.length > 0) {
                ...
                $.ajax({
                    type: "POST", // 数据提交类型
                    url: "https://daning-crm.cms.incker.com/api/upActivity",
                    data: formData, //发送数据
                    success:function (res) {
                        console.log(res);
                        if(res.code == 200){
                            imgList = $("input[name='ActivityInfoActivity_img']").val().split(",");

                            imgList[0] = res.url;

                            $("input[name='ActivityInfoActivity_img']").val(imgList.join(","));
                        }
