...
<head>
    <meta charset="UTF-8">
    <title>
        用户信息 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">姓名:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="姓名:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_name" value="<?php echo ($vo["user_name"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">身份证号:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="身份证号:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_id_card" value="<?php echo ($vo["user_id_card"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">社区:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="社区:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_community" value="<?php echo ($vo["user_community"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">地址:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="地址:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_address" value="<?php echo ($vo["user_address"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">手机号:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="手机号:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_mobile" value="<?php echo ($vo["user_mobile"]); ?>" required>      </div></div>
        </div>
