...
<head>
    <meta charset="UTF-8">
    <title>
        通知信息 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">通知标题:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="通知标题:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Notice_title" value="<?php echo ($vo["notice_title"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">通知内容:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="通知内容:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Notice_content" value="<?php echo ($vo["notice_content"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">通知排序:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="通知排序:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Notice_sort" value="<?php echo ($vo["notice_sort"]); ?>" required>      </div></div>
        </div>
