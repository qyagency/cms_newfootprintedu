...
<head>
    <meta charset="UTF-8">
    <title>
        竞猜信息 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">竞猜日期:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="竞猜日期:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Question_date" value="<?php echo ($vo["question_date"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">竞猜备注:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="竞猜备注:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Question_title" value="<?php echo ($vo["question_title"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">预告比赛标题:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="预告比赛标题:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Next_title" value="<?php echo ($vo["next_title"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">预告比赛日期:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="预告比赛日期:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Next_date" value="<?php echo ($vo["next_date"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">预告比赛第一场:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="预告比赛第一场:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Next_match1" value="<?php echo ($vo["next_match1"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">预告比赛第二场:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="预告比赛第二场:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Next_match2" value="<?php echo ($vo["next_match2"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">预告可竞猜时间:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="预告可竞猜时间:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Next_guess_time" value="<?php echo ($vo["next_guess_time"]); ?>" required>      </div></div>
        </div>
