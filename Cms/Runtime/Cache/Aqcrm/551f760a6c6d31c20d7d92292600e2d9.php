...
<head>
    <meta charset="UTF-8">
    <title>
        会员信息 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">姓名:</label>   <div class="col-md-8">       <input  placeholder="姓名:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_name" value="<?php echo ($vo["user_name"]); ?>" >      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">联系方式:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="联系方式:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>User_mobile" value="<?php echo ($vo["user_mobile"]); ?>" required>      </div></div>
        </div>
