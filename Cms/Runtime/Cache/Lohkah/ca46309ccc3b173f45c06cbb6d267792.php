...
<head>
    <meta charset="UTF-8">
    <title>
        权限管理 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
        ...
        <section class="panel">
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-md-2 control-label" for="GroupName">权限组名称<span class="required">*</span></label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="GroupName" name="GroupName"
                               value="<?php echo ($vo["name"]); ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">权限列表<span class="required">*</span></label>
                    <div class="col-md-8">
                        <?php if(is_array(C("POWER"))): foreach(C("POWER") as $K1=>$power): ?><div>
                                <label class="control-label label label-primary label-sm text-weight-normal va-middle mr-sm pull-right"><?php echo (C("CONTROLLER_NAME.$K1")); ?></label>
                                <div>
                                    <?php if(is_array($power)): foreach($power as $K2=>$action): ?><div class="checkbox-inline checkbox-custom checkbox-default">
                                            <input id="for-<?php echo ($K1); ?>-<?php echo ($K2); ?>" value="<?php echo ($K1); ?>.<?php echo ($K2); ?>"
                                            <?php echo in_array($K1.'.'.$K2,$vo['setting'])?'checked':''; ?>
                                            type="checkbox" name="for[]" required="" aria-required="true">
                                            <label for="for-<?php echo ($K1); ?>-<?php echo ($K2); ?>"><?php echo ($action); ?></label>
                                        </div><?php endforeach; endif; ?>
                                </div>
                            </div>
                            <hr class="short"/><?php endforeach; endif; ?>
                    </div>
                </div>
            </div>
