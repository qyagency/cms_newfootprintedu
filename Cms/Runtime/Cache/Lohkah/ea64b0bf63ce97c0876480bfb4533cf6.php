...
<head>
    <meta charset="UTF-8">
    <title>
        Banner管理 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
        ...
        <div id="userbox" class="userbox">
            <a href="#" data-toggle="dropdown">
                <figure class="profile-picture">
                    <!--<img src="/Public/Uploads/Lohkah/<?php echo ($_SESSION['user']['photo']); ?>" alt="<?php echo ($_SESSION['user']['nickname']); ?>" class="img-circle" data-lock-picture="/Public/Uploads/Lohkah/<?php echo ($_SESSION['user']['photo']); ?>" />-->
                </figure>
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">标题(中文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="标题(中文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>TitleCn" value="<?php echo ($vo["title_cn"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">标题(英文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="标题(英文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>TitleEn" value="<?php echo ($vo["title_en"]); ?>" required>      </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">详情（中文）<span class="required">*</span></label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>ContentCn" class="form-control" required ><?php echo ($vo["content_cn"]); ?></textarea>    </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">详情（英文）<span class="required">*</span></label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>ContentEn" class="form-control" required ><?php echo ($vo["content_en"]); ?></textarea>    </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">size(中文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="size(中文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>SizeCn" value="<?php echo ($vo["size_cn"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">size(英文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="size(英文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>SizeEn" value="<?php echo ($vo["size_en"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">beds(中文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="beds(中文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>BedsCn" value="<?php echo ($vo["beds_cn"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">beds(英文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="beds(英文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>BedsEn" value="<?php echo ($vo["beds_en"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">occupancy(中文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="occupancy(中文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>OccupancyCn" value="<?php echo ($vo["occupancy_cn"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">occupancy(英文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="occupancy(英文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>OccupancyEn" value="<?php echo ($vo["occupancy_en"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">extra_bed(中文)</label>   <div class="col-md-8">       <input  placeholder="extra_bed(中文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>ExtraBedCn" value="<?php echo ($vo["extra_bed_cn"]); ?>" >      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">extra_bed(英文)</label>   <div class="col-md-8">       <input  placeholder="extra_bed(英文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>ExtraBedEn" value="<?php echo ($vo["extra_bed_en"]); ?>" >      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">view(中文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="view(中文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>ViewCn" value="<?php echo ($vo["view_cn"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">view(英文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="view(英文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>ViewEn" value="<?php echo ($vo["view_en"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">location(中文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="location(中文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>LocationCn" value="<?php echo ($vo["location_cn"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">location(英文)<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="location(英文)" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>LocationEn" value="<?php echo ($vo["location_en"]); ?>" required>      </div></div>
            <div class="form-group">    <label class="col-md-2 control-label">排序<span class="required">*</span></label>    <div class="col-md-8">       <div data-plugin-spinner data-plugin-options='{ "value":<?php echo ($vo["sort"]); ?>, "min": 1, "max": 500 }'>           <div class="input-group" style="width:150px;">                <input name="<?php echo (CONTROLLER_NAME); ?>Sort" type="text" class="spinner-input form-control" maxlength="3" required readonly>                <div class="spinner-buttons input-group-btn">                    <button type="button" class="btn btn-default spinner-up">                        <i class="fa fa-angle-up"></i>                    </button>                    <button type="button" class="btn btn-default spinner-down">                        <i class="fa fa-angle-down"></i>                    </button>                </div>            </div>        </div>    </div></div>
        </div>
...
<!-- Specific Page Vendor -->
    ...
    <script type="text/javascript" src="/Public/vendor/fuelux/js/spinner.js"></script>
