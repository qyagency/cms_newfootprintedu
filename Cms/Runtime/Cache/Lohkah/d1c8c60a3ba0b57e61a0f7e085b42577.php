            ...
            <div class="panel-body pb-xlg">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">
                        权限组<span class="required">*</span>
                    </label>
                    <div class="col-md-8">
                        <select class="form-control mb-md" name="Group" size="<?php echo (count($groupList )); ?>" required>
                            <?php if(is_array($groupList)): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?><option value="<?php echo ($group["id"]); ?>" <?php if(($vo["group_id"]) == $group["id"]): ?>selected<?php endif; ?>><?php echo ($group["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="switch switch-sm switch-primary">
                            <input type="checkbox" name="Status" <?php if(($vo["status"]) != "0"): ?>checked<?php endif; ?> data-plugin-ios-switch />
                        </div>
                    </div>
                </div>
            </div>
