...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">banner类型<span class="required">*</span></label>   <div class="col-md-8">       <select data-plugin-selectTwo class="form-control" name="<?php echo (CONTROLLER_NAME); ?>TypeId" required  >               <option value="">请选择</option>           <?php if(is_array($vo["typeList"])): $i = 0; $__LIST__ = $vo["typeList"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vos["key"]); ?>" <?php echo ($vos["readonly"]); ?> <?php if(($vos["key"]) == $vo["type_id"]): ?>selected<?php endif; ?>><?php echo ($vos["label"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>       </select>   </div></div>
            <div class="form-group">    <label class="col-md-2 control-label">图片（pc）<span class="required">*</span></label>    <?php if(!empty($vo["pc_cover"])): ?><div class="col-md-2">            <div class="thumbnail">                <input type="hidden" name="<?php echo (CONTROLLER_NAME); ?>ExistedPcCover" value="<?php echo ($vo["pc_cover"]); ?>"/>                <a class="upareaRemove btn btn-xs" data-target="thumbnailPcCover"><i class="fa fa-remove"></i>删除</a>                <a class="upareaUnRemove btn btn-xs" data-target="thumbnailPcCover"><i class="fa fa-reply"></i>恢复</a>                <div class="thumb-preview">                    <img src="/Public/Uploads/Lohkah/<?php echo ($vo["pc_cover"]); ?>" class="img-responsive">                </div>            </div>        </div><?php endif; ?>    <div id="thumbnailPcCover" class="col-md-6" <?php if(!empty($vo["pc_cover"])): ?>style="display:none"<?php endif; ?>>        <div class="fileupload fileupload-new mb-md" data-provides="fileupload" >            <div class="input-append validate-area">                <div class="uneditable-input">                    <i class="fa fa-file fileupload-exists"></i>                    <span class="fileupload-preview"></span>                </div>            <span class="btn btn-default btn-file">                <span class="fileupload-exists">变更</span>                <span class="fileupload-new">选择文件</span>                <input type="file" name="<?php echo (CONTROLLER_NAME); ?>PcCover" required/>           </span>                <a href="#" class="btn btn-default fileupload-exists" data-dismiss="fileupload">移除</a>            </div>        </div>&nbsp;建议尺寸xxx*xxx    </div></div>
            <div class="form-group">    <label class="col-md-2 control-label">图片（mobile）<span class="required">*</span></label>    <?php if(!empty($vo["mobile_cover"])): ?><div class="col-md-2">            <div class="thumbnail">                <input type="hidden" name="<?php echo (CONTROLLER_NAME); ?>ExistedMobileCover" value="<?php echo ($vo["mobile_cover"]); ?>"/>                <a class="upareaRemove btn btn-xs" data-target="thumbnailMobileCover"><i class="fa fa-remove"></i>删除</a>                <a class="upareaUnRemove btn btn-xs" data-target="thumbnailMobileCover"><i class="fa fa-reply"></i>恢复</a>                <div class="thumb-preview">                    <img src="/Public/Uploads/Lohkah/<?php echo ($vo["mobile_cover"]); ?>" class="img-responsive">                </div>            </div>        </div><?php endif; ?>    <div id="thumbnailMobileCover" class="col-md-6" <?php if(!empty($vo["mobile_cover"])): ?>style="display:none"<?php endif; ?>>        <div class="fileupload fileupload-new mb-md" data-provides="fileupload" >            <div class="input-append validate-area">                <div class="uneditable-input">                    <i class="fa fa-file fileupload-exists"></i>                    <span class="fileupload-preview"></span>                </div>            <span class="btn btn-default btn-file">                <span class="fileupload-exists">变更</span>                <span class="fileupload-new">选择文件</span>                <input type="file" name="<?php echo (CONTROLLER_NAME); ?>MobileCover" required/>           </span>                <a href="#" class="btn btn-default fileupload-exists" data-dismiss="fileupload">移除</a>            </div>        </div>&nbsp;建议尺寸xxx*xxx    </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">文字描述（白、中文）</label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>WhiteContentCn" class="form-control"  ><?php echo ($vo["white_content_cn"]); ?></textarea>    </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">文字描述（白、英文）</label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>WhiteContentEn" class="form-control"  ><?php echo ($vo["white_content_en"]); ?></textarea>    </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">文字描述（红、中文）</label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>RedContentCn" class="form-control"  ><?php echo ($vo["red_content_cn"]); ?></textarea>    </div></div>
            <div class="form-group">    <label class="col-md-2 control-label" for="textareaDefault">文字描述（红、英文）</label>    <div class="col-md-8">        <textarea id="" rows="5" name="<?php echo (CONTROLLER_NAME); ?>RedContentEn" class="form-control"  ><?php echo ($vo["red_content_en"]); ?></textarea>    </div></div>
...
<!-- Specific Page Vendor -->
    ...
    <script type="text/javascript" src="/Public/vendor/bootstrap-multiselect/bootstrap-multiselect.js"></script>
    <!--<script type="text/javascript" src="/Public/vendor/ios7-switch/ios7-switch.js"></script>-->
    <!--<script type="text/javascript" src="/Public/vendor/select2/js/select2.js"></script>-->
