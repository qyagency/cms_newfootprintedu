...
<head>
    <meta charset="UTF-8">
    <title>
        地区信息 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">地区:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="地区:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Area_name" value="<?php echo ($vo["area_name"]); ?>" required>      </div></div>
        </div>
