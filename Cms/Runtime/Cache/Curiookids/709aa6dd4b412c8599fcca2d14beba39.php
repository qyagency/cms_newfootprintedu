...
<head>
    <meta charset="UTF-8">
    <title>
        账户管理 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">员工账号:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="员工账号:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Username" value="<?php echo ($vo["username"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">密码:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="密码:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Password" value="<?php echo ($vo["password"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">员工姓名:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="员工姓名:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Nickname" value="<?php echo ($vo["nickname"]); ?>" required>      </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">所属门店:<span class="required">*</span></label>   <div class="col-md-8">       <select data-plugin-selectTwo class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Store_id" required  >               <option value="">请选择</option>           <?php if(is_array($vo["StoreList"])): $i = 0; $__LIST__ = $vo["StoreList"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vos["key"]); ?>" <?php echo ($vos["readonly"]); ?> <?php if(($vos["key"]) == $vo["store_id"]): ?>selected<?php endif; ?>><?php echo ($vos["label"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>       </select>   </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">权限:<span class="required">*</span></label>   <div class="col-md-8">       <select data-plugin-selectTwo class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Group_id" required  >               <option value="">请选择</option>           <?php if(is_array($vo["GroupList"])): $i = 0; $__LIST__ = $vo["GroupList"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vos["key"]); ?>" <?php echo ($vos["readonly"]); ?> <?php if(($vos["key"]) == $vo["group_id"]): ?>selected<?php endif; ?>><?php echo ($vos["label"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>       </select>   </div></div>
