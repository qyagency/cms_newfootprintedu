...
<head>
    <meta charset="UTF-8">
    <title>
        门店信息 - 编辑 | HAPPY-SHARE Admin - Responsive HTML5 CMS
    </title>
...
<section class="body">
    ...
    <section class="panel">
        <div class="panel-body">
            <div class="form-group">   <label class="col-md-2 control-label">地区:<span class="required">*</span></label>   <div class="col-md-8">       <select data-plugin-selectTwo class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Area_id" required  >               <option value="">请选择</option>           <?php if(is_array($vo["AreaList"])): $i = 0; $__LIST__ = $vo["AreaList"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vos["key"]); ?>" <?php echo ($vos["readonly"]); ?> <?php if(($vos["key"]) == $vo["area_id"]): ?>selected<?php endif; ?>><?php echo ($vos["label"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>       </select>   </div></div>
            <div class="form-group">   <label class="col-md-2 control-label">门店名称:<span class="required">*</span></label>   <div class="col-md-8">       <input  placeholder="门店名称:" type="text" class="form-control" name="<?php echo (CONTROLLER_NAME); ?>Store_name" value="<?php echo ($vo["store_name"]); ?>" required>      </div></div>
        </div>
